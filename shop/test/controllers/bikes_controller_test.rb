...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { color: @bike.color, make: @bike.make, price: @bike.price, used_for: @bike.used_for } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { color: @bike.color, make: @bike.make, price: @bike.price, used_for: @bike.used_for } }
